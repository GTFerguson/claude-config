...
description: Generate architecture documentation for a codebase in a standard docs/ structure. Use when the user asks to document a project, generate architecture docs, or map a codebase's structure.
---
...
This skill can also be run across multiple related codebases to produce cross-project analysis and consolidation recommendations.
...
├── guides/                        # How-to instructions (not generated by this skill)
└── plans/                         # Project plans (not generated by this skill)
```

This skill generates the `docs/architecture/` directory. Reference docs, guides, and plans are authored separately.
...
{Mermaid flowchart showing component relationships.}
...
When documenting multiple related codebases, produce additional analysis after all individual docs are generated.
